...
export default {
  ...
  'character_active_reference': 'Active storyboard reference',
  'character_ref_empty': 'No reference image',
  'character_forms': 'Character forms',
  'add_character_form': 'Add form',
  'character_form_id': 'Form ID',
  'character_form_label': 'Form name',
  'character_form_desc': 'Form description',
  'default_form': 'Default form',
  'set_default_form': 'Set default',
  'character_input_refs': 'Full-body generation refs',
  'upload_input_ref': 'Upload full-body ref',
  'delete_input_ref': 'Delete full-body ref',
  'no_input_refs': 'No full-body refs',
  'character_ref_slot_full_body': 'Full body',
  'character_ref_slot_three_view': 'Three-view',
  'storyboard_ref_active': 'Storyboard default',
  'use_for_storyboard': 'Use for storyboard',
  ...
  'jianying_export_packaging': 'Generating and downloading the Jianying draft ZIP. Extract it only after the browser download finishes.',
  'jianying_export_transcribing': 'Using FunASR to transcribe subtitles and package the Jianying draft ZIP. Extract it only after the browser download finishes.',
  'jianying_export_downloaded': 'Jianying draft ZIP downloaded. Extract it into your Jianying drafts directory.',
  ...
  'select_all_episodes': 'Select All',
  'clear_episodes': 'Clear',
  'selected_episode_count': '{{count}} episodes selected',
  'episode_with_title': 'Episode {{episode}} — {{title}}',
  'jianying_draft_mode': 'Draft Merge Mode',
  'jianying_draft_mode_combined': 'Merge into one Jianying draft',
  'jianying_draft_mode_combined_hint': 'Selected episodes become one continuous timeline',
  'jianying_draft_mode_separate': 'Keep each episode as a separate draft',
  'jianying_draft_mode_separate_hint': 'The ZIP contains one draft folder per episode',
  'jianying_version': 'Jianying Version',
  'jianying_v6_plus': 'Jianying 6.0 and above (Recommended)',
  'jianying_v5_x': 'Jianying 5.x',
  'funasr_subtitles': 'Auto Subtitles',
  'funasr_subtitles_enabled': 'Use FunASR to generate editable subtitles',
  'funasr_subtitles_hint': 'Videos are transcribed locally before export. The first run downloads models; subtitles remain editable in Jianying.',
  ...
  'tool_name_list_pending_character_refs': 'List pending character refs',
  'tool_name_generate_character_refs': 'Generate character refs',
