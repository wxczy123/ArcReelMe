...
export default {
  ...
  'character_active_reference': '当前分镜参考图',
  'character_ref_empty': '暂无参考图',
  'character_forms': '角色形态',
  'add_character_form': '新增形态',
  'character_form_id': '形态 ID',
  'character_form_label': '形态名称',
  'character_form_desc': '形态描述',
  'default_form': '默认形态',
  'set_default_form': '设为默认',
  'character_input_refs': '全身图生成参考',
  'upload_input_ref': '上传全身图参考',
  'delete_input_ref': '删除全身图参考',
  'no_input_refs': '暂无全身图参考',
  'character_ref_slot_full_body': '全身图',
  'character_ref_slot_three_view': '三视图',
  'storyboard_ref_active': '分镜默认',
  'use_for_storyboard': '用于分镜',
  ...
  'jianying_export_packaging': '正在生成并下载剪映草稿 ZIP，请等浏览器下载完成后再解压',
  'jianying_export_transcribing': '正在使用 FunASR 识别字幕并打包剪映草稿 ZIP，请等浏览器下载完成后再解压',
  'jianying_export_downloaded': '剪映草稿 ZIP 已下载完成，请解压到剪映草稿目录中',
  ...
  'select_episode': '选择集数',
  'select_episodes': '选择导出剧集',
  'select_all_episodes': '全选',
  'clear_episodes': '清空',
  'selected_episode_count': '已选择 {{count}} 集',
  'episode_with_title': '第 {{episode}} 集 — {{title}}',
  'jianying_draft_mode': '草稿合并方式',
  'jianying_draft_mode_combined': '合并为一个剪映草稿',
  'jianying_draft_mode_combined_hint': '选中剧集会串成一条连续时间线',
  'jianying_draft_mode_separate': '每集作为独立剪映草稿',
  'jianying_draft_mode_separate_hint': 'ZIP 内包含多个第 N 集草稿目录',
  'jianying_version': '剪映版本',
  'jianying_v6_plus': '剪映 6.0 及以上（推荐）',
  'jianying_v5_x': '剪映 5.x',
  'funasr_subtitles': '自动字幕',
  'funasr_subtitles_enabled': '使用 FunASR 自动生成可编辑字幕',
  'funasr_subtitles_hint': '导出前会在本地识别视频语音，首次运行会下载模型；字幕可在剪映中继续修改。',
  'draft_path': '草稿目录路径',
  ...
  'tool_name_list_pending_character_refs': '查询待生成角色参考图',
  'tool_name_generate_character_refs': '生成角色参考图',
