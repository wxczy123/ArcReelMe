...
export default {
  ...
  'character_active_reference': 'Ảnh tham chiếu storyboard hiện tại',
  'character_ref_empty': 'Chưa có ảnh tham chiếu',
  'character_forms': 'Dạng nhân vật',
  'add_character_form': 'Thêm dạng',
  'character_form_id': 'ID dạng',
  'character_form_label': 'Tên dạng',
  'character_form_desc': 'Mô tả dạng',
  'default_form': 'Dạng mặc định',
  'set_default_form': 'Đặt mặc định',
  'character_input_refs': 'Ảnh tham chiếu tạo toàn thân',
  'upload_input_ref': 'Tải ảnh tham chiếu toàn thân',
  'delete_input_ref': 'Xóa ảnh tham chiếu toàn thân',
  'no_input_refs': 'Chưa có ảnh tham chiếu toàn thân',
  'character_ref_slot_full_body': 'Toàn thân',
  'character_ref_slot_three_view': 'Ba góc nhìn',
  'storyboard_ref_active': 'Mặc định storyboard',
  'use_for_storyboard': 'Dùng cho storyboard',
  ...
  'jianying_export_packaging': 'Đang tạo và tải ZIP bản nháp Jianying. Chỉ giải nén sau khi trình duyệt tải xong.',
  'jianying_export_transcribing': 'Đang dùng FunASR để nhận dạng phụ đề và đóng gói ZIP bản nháp Jianying. Chỉ giải nén sau khi trình duyệt tải xong.',
  'jianying_export_downloaded': 'Đã tải xong ZIP bản nháp Jianying. Hãy giải nén vào thư mục bản nháp Jianying.',
  ...
  'select_episodes': 'Chọn tập để xuất',
  'select_all_episodes': 'Chọn tất cả',
  'clear_episodes': 'Bỏ chọn',
  'selected_episode_count': 'Đã chọn {{count}} tập',
  'episode_with_title': 'Tập {{episode}} — {{title}}',
  'jianying_draft_mode': 'Cách gộp bản nháp',
  'jianying_draft_mode_combined': 'Gộp thành một bản nháp Jianying',
  'jianying_draft_mode_combined_hint': 'Các tập đã chọn trở thành một timeline liên tục',
  'jianying_draft_mode_separate': 'Mỗi tập là một bản nháp riêng',
  'jianying_draft_mode_separate_hint': 'ZIP chứa một thư mục bản nháp cho mỗi tập',
  'jianying_version': 'Phiên bản Jianying',
  'jianying_v6_plus': 'Jianying 6.0 trở lên (Khuyến nghị)',
  'jianying_v5_x': 'Jianying 5.x',
  'funasr_subtitles': 'Phụ đề tự động',
  'funasr_subtitles_enabled': 'Dùng FunASR để tạo phụ đề có thể chỉnh sửa',
  'funasr_subtitles_hint': 'Video sẽ được nhận dạng giọng nói cục bộ trước khi xuất. Lần đầu sẽ tải mô hình; phụ đề vẫn có thể chỉnh trong Jianying.',
  ...
  'tool_name_list_pending_character_refs': 'Liệt kê ảnh nhân vật chờ tạo',
  'tool_name_generate_character_refs': 'Tạo ảnh tham chiếu nhân vật',
